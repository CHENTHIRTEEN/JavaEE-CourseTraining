...
<body>
    ...
    <script type="text/html" id="toolBar">
        <a class="layui-btn layui-btn-mini" lay-event="updateOrder" >编辑</a>
        <a class="layui-btn layui-btn-mini layui-btn-danger" lay-event="deleteOrder" >删除</a>
    </script>
 <!--   <script type="text/html" id="userLevenTpl">
    ...
    <script>
        ...
        table.on('tool(order)', function(obj) {
            var data = obj.data;
            if (obj.event === 'updateOrder') {
                var index = layui.layer.open({
                    title : "编辑订单",
                    type : 2,
                    content : "${ctx}/order/toUpdateOrder?id="
                            + data.id,
            ...
            }else if (obj.event === 'deleteOrder') {
                layer.confirm('确定删除订单【'+data.id+'】吗?', function(index){
                    //layer.close(index);
                    //向服务端发送删除指令
                    $.ajax({
                        type : "post",
