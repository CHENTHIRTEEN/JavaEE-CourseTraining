...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <a href="javascript:;">
      ...
      <li class="layui-nav-item logout"> <a href="${ctx}/account/cusLogout">退出</a></li>
    </ul>
  </div>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item">
          <a class="" href="javascript:;">我的快递</a>
          <dl class="layui-nav-child">
            <dd><a href="#" onclick="getPage('${ctx}/express/showExpressList')">快递列表</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
          <a class="" href="javascript:;">订单列表</a>
          <dl class="layui-nav-child">
            <dd><a href="#" onclick="getPage('${ctx}/order/showOrderList')">所有订单</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
          <a class="" href="javascript:;">送货上门</a>
          <dl class="layui-nav-child">
            <dd><a href="#" onclick="getPage('${ctx}/order/showShipOrderList')">我的订单</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
